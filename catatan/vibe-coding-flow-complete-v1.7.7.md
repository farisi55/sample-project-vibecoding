...
language: English
changes_from: v1.7.6 — P04's Loop Decision now hard-stops after every task instead of auto-continuing through [NEXT TASKS]; Regression Gate (P03 + P04) requires a visible test command and pass/fail output instead of a narrative claim
---
