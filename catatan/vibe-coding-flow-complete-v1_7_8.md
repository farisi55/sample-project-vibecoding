...
language: English
changes_from: v1.7.7 — P04 Step 3 now pulls dev before branching, and Step 6 auto-merges (--no-ff) each task's branch into dev then deletes it immediately after passing, instead of leaving feat/* branches to accumulate until a final bulk PR; Appendix C's conflict-resolution target updated from main to dev to match; promoting dev to main remains a manual, developer-reviewed PR
---
