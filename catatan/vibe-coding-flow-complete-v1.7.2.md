...
language: English
changes_from: v1.7.1 — 2 findings applied (Data Schema promoted to a structured, column-level subsection; Architecture gains an explicit decision-rationale field)
---
