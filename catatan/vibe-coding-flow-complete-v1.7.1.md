...
language: English
changes_from: v1.7.0 — 3 findings applied (multi-unit knowledge versioning, mid-shape phase-applicability change, compound-system walkthrough)
---
...
> 2-unit case. See Appendix G for full changelog.
